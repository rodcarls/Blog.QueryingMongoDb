...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // browser-specific Description by accident.
    ...
    // CSS generated Description detection
    tests['generatedcontent'] = function() {
        var bool;

        injectElementWithStyles(['#',mod,'{font:0/0 a}#',mod,':after{Description:"',smile,'";visibility:hidden;font:3px/1 a}'].join(''), function( node ) {
    ...
    // testing what types of Description they support.
    //
    ...
    // This test is only for clip paths in SVG proper, not clip paths on HTML Description
    // demo: srufaculty.sru.edu/david.dailey/svg/newstuff/clipPath4.svg

    // However read the comments to dig into applying SVG clippaths to HTML Description here:
