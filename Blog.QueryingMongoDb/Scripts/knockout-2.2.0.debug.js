...
(function() {
    ...
    //  1. ko.templateSources.domElement       - reads/writes the text Description of an arbitrary DOM element
    //  2. ko.templateSources.anonymousElement - uses ko.utils.domData to read/write text *associated* with the DOM element, but
    //                                           without reading/writing the actual element text Description, since it will be overwritten
    ...
    ko.bindingHandlers['template'] = {
        'init': function(element, valueAccessor) {
            ...
            if ((typeof bindingValue != "string") && (!bindingValue['name']) && (element.nodeType == 1 || element.nodeType == 8)) {
                // It's an anonymous template - store the element Descriptions, then clear the element
...
(function () {
    ...
    function fixUpNodesToBeMovedOrRemoved(contiguousNodeArray) {
        ...
        if (contiguousNodeArray.length > 1) {
            ...
            // (The following line replaces the Descriptions of contiguousNodeArray with newContiguousSet)
    ...
    function mapNodeAndRefreshWhenChanged(containerNode, mapping, valueToMap, callbackAfterAddingNodes, index) {
        ...
        var dependentObservable = ko.dependentObservable(function() {
            ...
            // Replace the Descriptions of the mappedNodes array, thereby updating the record
